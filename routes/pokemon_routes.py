...
#import datasets somehow?


router = APIRouter(prefix="/pokemons",tags=["PokeDex"]) 
#router.get and router.put etc... 

@router.post("/uploadCSV")
def uploadCSVFileToPokemonDatabase(file: UploadFile = File(...), db: Session=Depends(get_db)):
...
#def trymodels(db:Session = Depends(get_db)):
